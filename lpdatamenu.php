...
<div class="smuanya">
        ...
        <div class="kanan">
            ...
            <h4><a href="lpmenu.html">Create</a></h4>
            ...
            <table cellpadding="15" cellspacing="0" width = 950px >
                ...
                <tr height = 50px class='data'>
                    ...
                    <td>$data[teks]</td>
                     <td>
                        <a href='lpformeditmenu.php?nomor=".$data ['nomor']."'>Edit </a> 
                        <a href='lphapusmenu.php?nomor=".$data ['nomor']."'>Hapus</a>
                    </td>
                </tr>
                    ";
                }
